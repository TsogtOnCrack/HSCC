...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center mt-5">
      ...
      <Input
        className = "w-[80vw]"
        val={data.whatyouknow}
        onchange={(event) => {
          setData({
            ...data,
            ['whatyouknow']: event.target.value,
          })
        }}
        size="big"
      ...
      <div className="flex flex-row items-center text-white w-[80vw]">
        ...
        <p className="font-roboto text-[20px] md:text-[30px] my-5">Do you have any experience coding?</p>
      </div>
      ...
      <Link href={'/check'}>
        <div
          ...
          className="md:fixed border-[2px] border-white text-white font-bebas text-[30px] md:border-0 cursor-pointer bottom-5 md:right-5 w-[275px] h-[95px] hover:w-[275px] hover:h-[100px] my-10 md:m-0 md:w-[100px] md:h-[100px] md:z-50 bg-[#EDAE49] rounded-[10px] flex justify-center items-center"
        >
          <h1 className="block md:hidden ">APPLY</h1>


            <h1 className="hidden md:flex hover:opacity-100 opacity-0 w-[100%] h-[100%] justify-center items-center ">APPLY</h1>
